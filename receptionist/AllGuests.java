...
public class AllGuests {
	 ...
	 */
	public AllGuests(ReceptionistController h) {
		HMS=h;
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblReceptionist = new JLabel("Guests Information");
		...
		JLabel lblRoomId = new JLabel("Guest ID");
		...
		table = new JTable(HMS.getGuests());

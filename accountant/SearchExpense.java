...
public class SearchExpense implements ActionListener{
	AccountantController HMS;
	JFrame frmUpdateSalary;
	private JTable table;

	public SearchExpense(AccountantController h) {
		HMS=h;
		initialize();
	}
	...
	private void initialize() {
		...
		frmUpdateSalary.setTitle("Manage Expenses");
		...
		JLabel lblUpdateSalary = new JLabel("Expenses");
		...
		table = new JTable(HMS.generateExpenseReport());
		...
		JLabel lblEmployeeId = new JLabel("Expense ID");
		...
		btnUpdate_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 UpdateExpense window2 = new UpdateExpense(HMS,Integer.parseInt(textField.getText().toString()));
				 window2.frmAddExpense.setVisible(true);
				 frmUpdateSalary.setVisible(false);
			}
		});
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 Add_expense window2 = new Add_expense(HMS);
				 window2.frmAddExpense.setVisible(true);
				 frmUpdateSalary.setVisible(false);
			}
		});
